...
export default function Home() {
  ...
  const paketList = [
    { ram: '1 GB', price: 'Rp5.000' },
    { ram: '2 GB', price: 'Rp9.000' },
    { ram: '3 GB', price: 'Rp13.000' },
    { ram: '4 GB', price: 'Rp17.000' },
    { ram: '8 GB', price: 'Rp30.000' },
    { ram: 'Unlimited', price: 'Rp50.000' },
  ];

  const handleSubmit = () => {
    if (!selected || !username || !email || !proof) return alert('Lengkapi semua data');
    alert(`Pesanan berhasil dikirim:\n${selected.ram} - ${duration}\nUser: ${username}`);
    // Simpan ke database di versi lanjut
  };
